...
var $, Button, Buttons, Dropdown, Form;

$ = jQuery;

window.PropelDesigner || (window.PropelDesigner = {
  UI: {
    Bootstrap: {
      Dropdown: Dropdown = (function() {
        ...
        Dropdown.makeDropdown = function(items) {
          var $list, item, makeListItem, _i, _len;
          $list = $("<ul>", {
            role: "menu",
          ...
          makeListItem = function(item) {
            var $listItem, action, event, _ref;
            $listItem = $("<li>");
            $listItem.append(function() {
              var $a, $item, theItem, _ref;
              $a = $("<a>", {
                tabindex: -1,
                href: "#"
              });
              if (typeof item === "string") {
                ...
                theItem = (_ref = item["item"]) != null ? _ref : item;
                $item = theItem instanceof jQuery ? theItem : $(theItem);
                $a.append($item);
              }
              return $a;
            });
    ...
    Build: {
      Buttons: Buttons = (function() {
        ...
        Buttons.addButtons = function($parent) {
    ...
    Button: Button = (function() {
      ...
      Button.makeDropdownButton = function(buttonText, $dropdown, options) {
        var $container;
        $container = $("<div>");
        ...
        return $container.append(function() {
          ...
          if (options.buttonSize) {
            $text.addClass("btn-" + options.buttonSize);
          }
    ...
    Form: Form = (function() {
      ...
      Form.addHelpText = function($element, helpTtext, displayType) {
        var $help;
        displayType = displayType === "block" ? "block" : "inline";
        $help = $("<span>");
      ...
      Form.makeControlGroup = function($controls, $label) {
        var $group;
        $group = $("<div>");
        $group.addClass("control-group");
        return $group.append(function() {
          var $controlsDiv;
          $controlsDiv = $("<div>");
